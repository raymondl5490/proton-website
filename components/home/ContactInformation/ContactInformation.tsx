    ...
    <div className={styles.container}>
      <div className={styles.inner}>
        ...
        <div className={styles.contactInformation}>
          ...
          <p className={styles.ciText}>
            <FontAwesomeIcon icon={faEnvelope} className={styles.icon} /> Media:
            media@protonmail.com
          </p>
          <p className={styles.ciText}>
            <FontAwesomeIcon icon={faEnvelope} className={styles.icon} /> Legal:
        ...
        <div className={styles.contactInformation}>
          <p className={styles.ciText}>
            <FontAwesomeIcon icon={faEnvelope} className={styles.icon} /> Abuse:
